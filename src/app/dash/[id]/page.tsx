                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      {round.financialInfo && (
                        <div>
                          ...
                          <div className="text-sm text-neutral-600 mt-1  w-full">
                            <Markdown>{round.financialInfo}</Markdown>
                          </div>
                      ...
                      {round.sentiment && (
                        <div>
                          ...
                          <div className="text-sm text-neutral-600 mt-1  w-full">
                            <Markdown>{round.sentiment}</Markdown>
                          </div>
                        </div>
                      )}
                      ...
                      {round.customerInfo && (
                        <div>
                          ...
                          <div className="text-sm text-neutral-600 mt-1  w-full">
                            <Markdown>{round.customerInfo}</Markdown>
                          </div>
                        </div>
                      )}
